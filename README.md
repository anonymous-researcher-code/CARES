...
CARES is a code review method that combines retrieval-augmented generation (RAG) with code understanding models to generate high-quality code review comments across multiple programming languages.

## Overview

- **Retrieval**: Fine-tuned retrieval models (CodeT5, UniXcoder) retrieve relevant context
